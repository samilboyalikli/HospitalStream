...
def case_production():
    ...
    return {
        ...
        "Hospital":"SAN FRANCISCO HOSPITAL",
...
try:
    ...
    sys.stdout.flush()
    producer.send("hospital_kafka", f"Send {message_count} messages from San Francisco Hospital.")
    producer.send("hospital_kafka", "info - San Francisco stream finished.")
