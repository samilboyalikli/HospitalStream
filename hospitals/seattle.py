...
try:
    ...
    sys.stdout.flush()
    producer.send("raw_stream", f"Send {message_count} messages from Seattle Hospital.")
    producer.send("raw_stream", "info - Seattle stream finished.")
