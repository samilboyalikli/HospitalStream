...
try:
    ...
    sys.stdout.flush()
    producer.send("hospital_kafka", f"Send {message_count} messages from Boston Hospital.")
    producer.send("hospital_kafka", "info - Boston stream finished.")
