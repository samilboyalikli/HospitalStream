...
try:
    ...
    sys.stdout.flush()
    producer.send("hospital_kafka", f"Send {message_count} messages from New Jersey Hospital.")
    producer.send("hospital_kafka", "info - New Jersey stream finished.")
